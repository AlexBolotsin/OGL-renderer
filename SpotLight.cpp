...
SpotLight::SpotLight(glm::vec2 shadowSize, glm::vec3 col, GLfloat aintensity, GLfloat dIntensity,
    glm::vec3 pos, glm::vec3 dir, GLfloat con, GLfloat lin, GLfloat exp, GLfloat edg) : PointLight(shadowSize, col, aintensity, dIntensity,
        pos, con, lin, exp)
{
